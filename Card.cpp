...
int main() {
    ...
    //Luhn Algorigthm to validate a CC number.//
    ...
    while (true) {
        ...
        /* 1) Double every second digit, starting from the right. If it
        ...
        /* 2) Add every odd placed digit from the right to the value
         'doubleEvenSum'.*/
        ...
        /* 3) Check if the final 'doubleEvenSum' is a multiple of 10.
